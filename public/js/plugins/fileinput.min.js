...
$(function () {
  $(".files-upload-wrap").each(function () {
    var $target = $(this);
    var uploadUrl = !!$target.attr("data-upload-url") ? $target.attr("data-upload-url") : "";
    var dropZoneEnabled = $target.attr("data-drop-zone") == "true";
    var showPreview = $target.attr("data-show-preview") == "false" ? false : true;
    var allowedFileExtensions = ($target.attr("data-accept") || "").split(",");
    var disabled = $target.attr("data-disabled") == "true";
    var initUrl = !!$target.attr("data-default-imgurl") ? $target.attr("data-default-imgurl") : "";
    var maxFileSize=!!$target.attr("data-max-size") ? $target.attr("data-max-size") : "";
    var uploadExtraData = {},
        item = null,
        value = null,
        key = null,
        argArr = !!$target.attr("data-extra-data") && typeof $target.attr("data-extra-data")=="string" ? $target.attr("data-extra-data").split("&") : [];
    for (var i = 0, len = argArr.length; i < len; i++) {
        item = argArr[i].split("=");
        key = item[0];
        value = item[1];
        uploadExtraData[key] = value;
    }
    $target.fileinput({
      uploadUrl: uploadUrl,
      disabled: disabled,
