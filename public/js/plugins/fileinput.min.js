...
$(function(){
  console.log([$('.files-upload-wrap').attr("data-upload-url"),$('.files-upload-wrap').attr("data-dropZone-enabled")])
  $('.files-upload-wrap').fileinput({
    uploadUrl: $('.files-upload-wrap').attr("data-upload-url"),
    showCaption: false,
    dropZoneEnabled: $('.files-upload-wrap').attr("data-dropZone-enabled")=="true",
    showUpload: true,
    showRemove: true,
    showClose: false,
    layoutTemplates:{
