          ...
          layer.confirm('确定删除？', {
            ...
            layer.close(index);
             $.ajax({
               ...
               success:function(){
                layer.success("删除成功");
                $("#"+_parentTable).find("a[data-row-index='"+_key+"']").parents("tr").eq(0).remove();
...
$(document).on('click', "[data-toggle='operate-iframe-pop']", function (e) {
  ...
  $("[data-toggle='table-pagination']").each(function(){
    ...
    // var pageTotal=$(this).attr("data-page-total")||0; //总共多少条
    ...
    var pageTotal=250; //总共多少条
    var jumpUrl="/admin/auth/adminlog";
    var pageNumer=(pageTotal%pageSize)==0?parseInt(pageTotal/pageSize):(parseInt(pageTotal/pageSize)+1);//总共分多少页
    var pageList=[10,25,50],listStr='',pageNumberStr="",pageArr=[];
    ...
    var lfStr='<div class="pull-left pagination-detail">';
      lfStr+='<span class="pagination-info">显示第 1 到第 10 条记录，总共'+pageTotal+' 条记录</span>';
